...
*-------------------------------------------------------------------------------
    ORG    $1000
OUTPUT_ADDRESS_CURRENT_POINTER EQU $7010
* OUTPUT_ADDRESS STORES BUFFER FOR PRINTING
OUTPUT_ADDRESS EQU $7014
...
START:
    ...
    MOVE.L #$010000, (A0)
LOOP_START:
    MOVE.L #0, (OUTPUT_ADDRESS_CURRENT_POINTER)
...
PRINT_COMMA:
    MOVE.L #OUTPUT_ADDRESS, A1
    ADDA.l (OUTPUT_ADDRESS_CURRENT_POINTER), A1 
    MOVE.B #',', (A1)+
    MOVE.B #' ', (A1)+
    ADDQ.L #2, (OUTPUT_ADDRESS_CURRENT_POINTER)
    * MOVE.B #0, (A1)
    * SUBQ.L #2, A1
END_PRINT_COMMA:
    * MOVE.B #14, D0
...
PRINT_DOLLAR_SIGN:
    ...
    ADDA.L (OUTPUT_ADDRESS_CURRENT_POINTER), A1
    MOVE.B #'$', (A1)
    ADDQ.L #1, (OUTPUT_ADDRESS_CURRENT_POINTER)
    * MOVE.B #0, 1(A1) 
...
OR_PATTERN EQU  %1000000100000000
OR_PATTERN1 EQU %1000000101000000
OR_PATTERN2 EQU %1000000110000000
